	...
	<div id="task_title" class="center-align">
		<div class="row">
			...
			<div class="col s2  offset-s2" style="margin-top: 2vh;">
				<a class="btn-floating btn-large waves-effect waves-light modal-trigger" style="background-color: #CC7120;" href="#modal1"><i class="material-icons hover-button">add</i></a>
			</div>
		</div>
